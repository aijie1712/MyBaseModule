 ...
 * from https://github.com/zcweng/RoundImageView
 */
...
public class HoverImageView extends AppCompatImageView {
    ...
    private void setup(AttributeSet attrs) {
        if (attrs != null) {
            ...
            hoverColor = typedArray.getColor(R.styleable.CircleImageView_hoverColor, hoverColor);
            borderWidth = typedArray.getDimension(R.styleable.CircleImageView_myBorderWidth, borderWidth);
            typedArray.recycle();
        }
